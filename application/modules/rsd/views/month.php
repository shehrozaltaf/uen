            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                      <td>7</td>
                      <td>Total New Cases OB/GYN (OPD)</td>
                      <td><?php echo $month->dhis_7; $total++;?></td>
                      <td><?php echo $month->sr_7;?></td>
                      <td><?php if($month->dhis_7 == $month->sr_7){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  
                  
                  <tr>
                      <td>8</td>
                      <td>Referred Cases attended (OB/GYN)-OPD</td>
                      <td><?php echo $month->dhis_8; $total++;?></td>
                      <td><?php echo $month->sr_8;?></td>
                      <td><?php if($month->dhis_8 == $month->sr_8){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  ...
                  <tr>
                      ...
                      <td><?php echo $month->dhis_11; $total++;?></td>
                      <td><?php echo $month->sr_11;?></td>
                      <td><?php if($month->dhis_11 == $month->sr_11){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  ...
                  <tr>
                      ...
                      <td><?php echo $month->dhis_12; $total++;?></td>
                      <td><?php echo $month->sr_12;?></td>
                      <td><?php if($month->dhis_12 == $month->sr_12){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  ...
                  <tr>
                      ...
                      <td><?php echo $month->dhis_13; $total++;?></td>
                      <td><?php echo $month->sr_13;?></td>
                      <td><?php if($month->dhis_13 == $month->sr_13){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  
                  
                  <tr>
                      <td>14</td>
                      <td>Prolonged Obstructed Labors</td>
                      <td><?php echo $month->dhis_14; $total++;?></td>
                      <td><?php echo $month->sr_14;?></td>
                      <td><?php if($month->dhis_14 == $month->sr_14){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  ...
                  <tr>
                      ...
                      <td><?php echo $month->dhis_15; $total++;?></td>
                      <td><?php echo $month->sr_15;?></td>
                      <td><?php if($month->dhis_15 == $month->sr_15){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  ...
                  <tr>
                      ...
                      <td><?php echo $month->dhis_16; $total++;?></td>
                      <td><?php echo $month->sr_16;?></td>
                      <td><?php if($month->dhis_16 == $month->sr_16){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  ...
                  <tr>
                      <td>21</td>
                      <td>Number of cases with birth asphyxia</td>
                      <td><?php echo $month->dhis_21; $total++;?></td>
                      <td><?php echo $month->sr_21;?></td>
                      <td><?php if($month->dhis_21 == $month->sr_21){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  
                  
                  <tr>
                      <td>25</td>
                      <td>Prematurity (no. of pre-term births)</td>
                      <td><?php echo $month->dhis_25; $total++;?></td>
                      <td><?php echo $month->sr_25;?></td>
                      <td><?php if($month->dhis_25 == $month->sr_25){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  ...
                  <tr>
                      <td>26</td>
                      <td>Birth trauma</td>
                      <td><?php echo $month->dhis_26; $total++;?></td>
                      <td><?php echo $month->sr_26;?></td>
                      <td><?php if($month->dhis_26 == $month->sr_26){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  
                  
                  <tr>
                      <td>27</td>
                      <td>Number of Infant deaths (1 -11 months)</td>
                      <td><?php echo $month->dhis_27; $total++;?></td>
                      <td><?php echo $month->sr_27;?></td>
                      <td><?php if($month->dhis_27 == $month->sr_27){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
                  ...
                  <tr>
                      <td>40</td>
                      <td>Referred Cases attended (Pediatrics)</td>
                      <td><?php echo $month->dhis_40; $total++;?></td>
                      <td><?php echo $month->sr_40;?></td>
                      <td><?php if($month->dhis_40 == $month->sr_40){ $correct++; ?><span class="label label-success">Matched</span><?php } else { ?><span class="label label-danger">Mismatched</span><?php } ?></td>
                  </tr>
