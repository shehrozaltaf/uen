  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a href="<?php echo base_url();?>qoc/create_user" class="btn btn-info pull-right">Add User</a>
      </h1>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped" width="100%">
                ...
                <tbody>
                	...
                	<tr>
                      ...
                      <td><?php echo $this->qoc_model->_get_district_name($row->district_code);?></td>
                      <td><?php echo $row->designation;?></td>
                      <td><?php echo $row->auth_level;?></td>
                      <td><?php echo anchor("qoc/edit_user/".$row->username, 'Edit', 'class="btn-xs btn-info"');?> | <?php echo anchor("qoc/delete_user/".$row->username, 'Delete', 'class="btn-xs btn-danger"');?></td>
                  </tr>
                  <?php } ?>
